...
pub mod pallet {
	...
	pub struct MyStuff<T: Config> {
		field_1: T::AccountId,
		field_2: BoundedVec<u8, T::MaxLen>,
	}

	#[pallet::storage]
	type MyFirstThing<T: Config> = StorageValue<_, BoundedVec<T::AccountId, ConstU32<100>>>;

	#[pallet::storage]
	type MyFavoriteAccount<T: Config> = StorageValue<_, T::AccountId>;
	...
	pub enum Event<T: Config> {
		...
		AccountsSponsored {
			...
			who: BoundedVec<T::AccountId, ConstU32<100>>,
		},
	}
